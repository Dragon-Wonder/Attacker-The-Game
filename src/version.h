...
namespace Version{
	...
	//Software Status
	#define DEFINED_VER_STATUS  "Gamma"
	#define DEFINED_VER_STATUS_SHORT  "c"
	
	//Standard Version Type
	#define DEFINED_VER_MAJOR  1
	#define DEFINED_VER_MINOR  5
	#define DEFINED_VER_BUILD  3
	#define DEFINED_VER_REVISION  1654
	
	//Miscellaneous Version Types
	#define DEFINED_VER_BUILDS_COUNT  20
	#define DEFINED_VER_RC_FILEVERSION 1,5,3,20
	#define DEFINED_VER_RC_FILEVERSION_STRING "1, 5, 3, 20\0"
	#define DEFINED_VER_FULLVERSION_STRING  "1.5.3.20"
	
	//These values are to keep track of your versioning state, don't modify them.
	#define DEFINED_VER_BUILD_HISTORY  18
