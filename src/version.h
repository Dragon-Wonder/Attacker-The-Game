...
#define DEFINED_VER_RC_FILEVERSION 0,9,1,64

/** Is the same as DEFINED_VER_RC_FILEVERSION but is a null terminated string */
#define DEFINED_VER_RC_FILEVERSION_STRING "0, 9, 1, 64\0"

/** A more specific string of the file version */
#define DEFINED_VER_FULLVERSION_STRING  "0.9.1-Alpha\0"
